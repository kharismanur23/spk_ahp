...
If rsiswa.State = adStateOpen Then rssiswa.Close
rssiswa.Open "select * from tb_siswa where nis like '%" & txtcari & "%'", koneksidb
If Not rssiswa.EOF Then
txtnis.Text = rssiswa!nis
txtnama.Text = rssiswa!nama
txttempatlahir.Text = rssiswa!t_lahir
txttgllahir.Text = rssiswa!tgl_lahir
cmbjk.Text = rssiswa!jk
txtalamat.Text = rssiswa!alamat
cmbjurusan.Text = rssiswa!jurusan
...
If ubah = vbYes Then
koneksidb.Execute "update tb_siswa set nama='" & txtnama & "',t_lahir='" & txttempatlahir & "',tgl_lahir='" & txttgllahir & "',jk='" & cmbjk & "',alamat='" & txtalamat & "',jurusan='" & cmbjurusan & "',telpon='" & txttelpon & "' where nis='" & txtnis & "'"
...
rssiswa.Open "select * from tb_siswa where nis='" & txtnis.Text & "'", koneksidb
If Not rssiswa.EOF Then
MsgBox "nis sudah digunakan", vbCritical, "pesan"
txtnis.Text = ""
txtnis.SetFocus
Exit Sub
Else
koneksidb.Execute "insert into tb_siswa(nis,nama,t_lahir,tgl_lahir,jk,alamat,jurusan,telpon) value ('" & txtnis & "','" & txtnama & "','" & txttempatlahir & "','" & txttgllahir & "','" & cmbjk & "','" & txtalamat & "','" & cmbjurusan & "','" & txttelpon & "')"
...
Set rssiswa = New ADODB.Recordset
rssiswa.Open "select * from tb_siswa where nis like '%" & txtcari.Text & "%'", koneksidb
If Not rssiswa.EOF Then
Set DataGrid1.DataSource = rssiswa
Call edit_grid
End If
