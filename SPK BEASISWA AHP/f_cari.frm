...
f_daftar.cmbnim.Text = rssiswa!nim
f_daftar.txtnama.Text = rssiswa!nama
f_daftar.txttempatlahir.Text = rssiswa!t_lahir
f_daftar.txttanggallahir.Text = rssiswa!tgl_lahir
f_daftar.txtjk.Text = rssiswa!jk
f_daftar.txtalamat.Text = rssiswa!alamat
f_daftar.txtjurusan.Text = rssiswa!jurusan
f_daftar.txttelpon.Text = rssiswa!telpon
Call bukadb
Call tampil_data
Set DataGrid1.DataSource = rssiswa
With DataGrid1
...
If Not rssiswa.EOF Then
If f_daftar.Visible = True Then
f_daftar.txtnis.Text = rssiswa!nis
f_daftar.txtnama.Text = rssiswa!nama
f_daftar.txttempatlahir.Text = rsiswa!t_lahir
f_daftar.txttanggallahir.Text = rssiswa!tgl_lahir
f_daftar.txtjk.Text = rssiswa!jk
f_daftar.txtalamat.Text = rssiswa!alamat
f_daftar.txtjurusan.Text = rssiswa!jurusan
